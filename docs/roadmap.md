...
Airedmaine は、AI エージェントを通じて Redmine を利用する開発体験を探索するためのアプリである。
...
- 新しい開発者や PM が、ローカルで Airedmaine と OSS 版 Redmine をすぐ試せる。
...
- Airedmaine からローカル Redmine に接続する手順が README にある。
